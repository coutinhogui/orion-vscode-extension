...
exports.buildCopilotInstructions = buildCopilotInstructions;
exports.buildEngineeringStandards = buildEngineeringStandards;
exports.buildWorkspaceSetupFiles = buildWorkspaceSetupFiles;
exports.buildDatabricksPipelineFiles = buildDatabricksPipelineFiles;
exports.buildDotnetApiFiles = buildDotnetApiFiles;
exports.buildBlazorFiles = buildBlazorFiles;
exports.buildTechnicalDocumentation = buildTechnicalDocumentation;
exports.buildStandardsMessage = buildStandardsMessage;
exports.buildChecklistMessage = buildChecklistMessage;
...
function buildEngineeringStandards() {
...
function buildWorkspaceSetupFiles(defaultDataBase) {
    return [
...
function buildDatabricksPipelineFiles(inputName, defaultDataBase) {
    const name = (0, naming_1.normalizeName)(inputName);
...
function buildDotnetApiFiles(inputName) {
    const className = (0, naming_1.toPascalCase)(inputName);
    const kebab = (0, naming_1.normalizeName)(inputName);
...
function buildBlazorFiles(inputName) {
    const className = (0, naming_1.toPascalCase)(inputName);
    const kebab = (0, naming_1.normalizeName)(inputName);
...
function buildTechnicalDocumentation(workspaceName) {
    return [
        {
...
function buildStandardsMessage() {
